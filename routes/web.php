...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('login', [AdminController::class, 'postLogin'])->name('admin.login.submit');

    Route::get('groups', [GroupController::class, 'adminIndex'])->name('admin.groups.index');

    Route::get('schedule', [ScheduleController::class, 'adminIndex'])->name('admin.schedule.index');
